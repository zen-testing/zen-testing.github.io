...
# after
Exec=env http_proxy=http://192.168.1.10:8889/ /usr/bin/steam  -tcp %U
```

### /usr/local/applications/steam/desktop
...
Comment[fr]=Application de gestion et dutilisation des jeux sur Steam
...
Comment[it]=Applicazione per la gestione e lesecuzione di giochi su Steam
...
Name[uk]=Крамниця
Name[vi]=Cửa hàng
Exec=env http_proxy=http://192.168.1.10:8889/ steam steam://store  -tcp %U
...
Name[uk]=Спільнота
Name[vi]=Cộng đồng
Exec=env http_proxy=http://192.168.1.10:8889/ steam steam://url/SteamIDControlPage -tcp %U
...
Name[uk]=Бібліотека
Name[vi]=Thư viện
Exec=env http_proxy=http://192.168.1.10:8889/ steam steam://open/games  -tcp %U
...
Name[uk]=Сервери
Name[vi]=Máy chủ
Exec=env http_proxy=http://192.168.1.10:8889/ steam steam://open/servers  -tcp %U
...
Name[uk]=Скріншоти
Name[vi]=Ảnh chụp
Exec=env http_proxy=http://192.168.1.10:8889/ steam steam://open/screenshots  -tcp %U
...
Name[uk]=Новини
Name[vi]=Tin tức
Exec=env http_proxy=http://192.168.1.10:8889/ steam steam://open/news  -tcp %U
...
Name[vi]=Thiết lập
Exec=env http_proxy=http://192.168.1.10:8889/ steam steam://open/settings  -tcp %U

[Desktop Action BigPicture]
Name=Big Picture
Exec=env http_proxy=http://192.168.1.10:8889/ steam steam://open/bigpicture  -tcp %U
...
Name[uk]=Друзі
Name[vi]=Bạn bè
Exec=env http_proxy=http://192.168.1.10:8889/ steam steam://open/friends  -tcp %U
```